        ...
        <div className={"app—bg—container overflow—hidden"}>
            ...
            >
                ...
                <CalculatorAndSidePannel>
                                        ...
                                        >
                                            {
                                                (invested < finalInvest) ?
                                                    <>
                                                        ...
                                                        in the period of <span className={"font-semibold"}>{years}</span> years.
                                                    </>
                                                    : (invested === finalInvest) ?
                                                        <>
                                                            There is no growth observed from <span className={"font-semibold"}>&#8377;{(invested).toLocaleString('en-In')}</span> in the <span className={"font-semibold"}>{years}</span> year period.
                                                        </>
                                                        :
                                                        <>You have lost
                    ...
                    {/* Side Pannel */}
                    <div className="xl:max-h-[363.2px] [@media(min-width:1920px)]:max-h-[390.2px]  xl:w-[23%] ">
                        <InfoBox
                            type={"sidePannel"}
                            contents={[
                                [
